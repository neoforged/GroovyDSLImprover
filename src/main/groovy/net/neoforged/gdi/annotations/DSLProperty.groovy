...
package net.neoforged.gdi.annotations
...
@interface DSLProperty {
     ...
     * If not specified it will be computed from the {@link #propertyName()} using {@link net.neoforged.gdi.transformer.Unpluralizer#unpluralize(java.lang.String)}.
     */
